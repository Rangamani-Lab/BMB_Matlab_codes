...
function dC=fun_s_mod123_revision(t,C,kmG_on,ktG_on,k1_on,k2_on,k3_on,kmG_off,ktG_off)
...
dC = [ - kmG_on*mGEF_act*mG + kmG_off*mGAP_act*mG_act
       ...
       - ktG_on*tGEF_act*tG + ktG_off*tGAP_act*tG_act
         ktG_on*tGEF_act*tG - ktG_off*tGAP_act*tG_act - k3_on*mGAP*tG_act
       - k1_on*tGEF*mG_act
         k1_on*tGEF*mG_act - k2_on*tGEF_act*mGAP
       - k3_on*mGAP*tG_act - k2_on*tGEF_act*mGAP
         k3_on*mGAP*tG_act + k2_on*tGEF_act*mGAP
         0
         0
         0
